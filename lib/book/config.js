...
// 9am–7pm, hourly. Only real Notion bookings close a slot.
...
export const FIT_KEYS = ["pricing", "decision", "ready"];

export const FIT_CHECKS = [
  {
    key: "pricing",
    title: "I understand pricing",
    body: "I understand projects start at more than $1,000.",
  },
  {
    key: "decision",
    title: "I'm the decision-maker",
    body: "I'm the founder or the one calling the shots on this project.",
  },
  {
    key: "ready",
    title: "I'm ready to start",
    body: "I want to begin something now, not just explore for later.",
  },
];

export function hasAllFitChecks(list) {
  if (!Array.isArray(list)) return false;
  return FIT_KEYS.every((key) => list.includes(key));
}
